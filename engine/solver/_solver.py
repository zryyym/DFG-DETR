...
class BaseSolver(object):
    ...
    def _setup(self):
        ...
        #     """Comprehensive weight initialization for various layer types"""
        #     # 先处理特殊层类型
        ...
        #
        #     elif isinstance(module, (nn.BatchNorm2d, FrozenBatchNorm2d, nn.GroupNorm, nn.LayerNorm)):
        #         # 归一化层初始化
        ...
        #     print("Model weights initialized using custom scheme")
